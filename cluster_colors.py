...
# init the list of color choices
colors = [
    #shades of R, G, B
    (138, 8, 8), (180, 4, 4), (223, 1, 1), (255, 0, 0), (250, 88, 88),
    (8, 138, 8), (4, 180, 4), (1, 223, 1), (0, 255, 0), (46, 252, 46),
...
# convert the canvas to grayscale, threshold it
# and detect contours in the image
...
# loop over the unique cluster ID's
