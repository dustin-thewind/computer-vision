...
from lab_11_1_2.markers import DistanceFinder
...
ap.add_argument("-w", "--ref_width_inches", required=True, type=float,
	help="reference object width in inches")
ap.add_argument("-d", "--ref_distance_inches", required=True, type=float,
