...
# USAGE
# python evaluate_spatial_verify.py --dataset ../images/ukbench1000 --features-db hdf5_output/features.hdf5 \
#	--bovw-db hdf5_output/bovw.hdf5 --codebook hdf5_output/vocab.cpickle --idf hdf5_output/idf.cpickle --relevant ../images/ukbench1000/relevant.json
...
for (i, queryID) in enumerate(sorted(queryIDs)):
    ...
    # perform the search and spatially verify
