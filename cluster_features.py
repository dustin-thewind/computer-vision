# usage
# python cluster_features.py --features-db output/features.hdf5 --codebook output/vocab.cpickle \
#	--clusters 1536 --percentage 0.25

# import packages
from __future__ import print_function
from prod_cbir.ir import Vocabulary
import argparse
import pickle
