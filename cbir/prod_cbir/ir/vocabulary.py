...
class Vocabulary:
    def __init__(self, dbPath, verbose=True):
        # store the db path and verbosity setting
        self.dbPath = dbPath
    ...
    def fit(self, numClusters, samplePercent, randomState=None):
        ...
        # of the sample, sorting them in ascending order, to speed up access
        ...
        # loop over the randomly sampled indexes and accumulate
