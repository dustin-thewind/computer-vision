...
# python search_spatial_verify.py --dataset ../ukbench1000 --features-db hdf5_output/features.hdf5 --bovw-db hdf5_output/bovw.hdf5 \
#   --codebook hdf5_output/vocab.cpickle --relevant ..images/ukbench1000/relevant.json --query .0images/ukbench1000/ukbench00258.jpg
