# USAGE
# python train_detector.py -c /stop_sign_images -a /stop_sign_annotations -o /output
...
# grab the default training options for our HOG + Linear SVM detector, then init
# the list of image and bounding boxes used the train the classifier
...
for imagePath in paths.list_images(args["class"]):
    ...
    # loop over the annotations and add each annotation to the list
    # of bounding boxes
...
# train the object train_detector
print("[INFO] training detector...")
detector = dlib.train_simple_object_detector(images, boxes, options)

# dump the classifier to file
print("[INFO] dumping classifier to file in folder {} ...".format(args["output"]))
